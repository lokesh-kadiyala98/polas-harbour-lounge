                ...
                <div className="row justify-content-md-center">
                    <div className="col-xs-12 col-sm-4">
                        <blockquote>
                            ...
                            <cite><img src={s3BucketName + 'customer-1.jpg'} alt="Customer 1" />Riyaz</cite>
                        </blockquote>
                    </div>
                    <div className="col-xs-12 col-sm-4">
                        <blockquote>
                            ...
                            <cite><img src={s3BucketName + 'customer-2.jpg'} alt="Customer 2" />Arvind C</cite>
                        </blockquote>
                    </div>
                    <div className="col-xs-12 col-sm-4">
                        <blockquote>
                            ...
                            <cite><img src={s3BucketName + 'customer-3.jpg'} alt="Customer 3" />Gagana Bhari</cite>
                        </blockquote>
                    </div>
                </div>
            </section>
